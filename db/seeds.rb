...
debates4 = Debate.create(topic: "Indian involvment in nepal politics is ruinig nepal.", description: "Nepali politician should understand that depending on India will eventually harm themself and in return to whole Nepal.", user_id: 3)
